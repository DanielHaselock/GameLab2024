namespace Audio
{
    public static class AudioConstants
    {
        ...
        public static string LaterLevel = "later_level"; //played externally
        public static string Battle1 = "battle_1"; //played externally
        public static string BossSouvlaki = "boss_souvlaki"; //played externally
        ...
        //Enemies
        public static string BossSouvlakiExplosion = "boss_souvlaki_explosion"; //played externally
        ...
        public static string BurgerAttack = "burger_chomps";
